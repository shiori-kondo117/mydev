...
Private Sub cmdResisterData()
	...
	objRecordSet.AddNew
	objRecordSet("ÇcÇuî‘çÜ") = F_DV_NO.value
	objRecordSet("éÊçûäJénà íu") = F_IMP_START_TIME.value
	objRecordSet("éÊçûèIóπà íu") = F_IMP_END_TIME.value
	objRecordSet("ò^âÊì˙ït") = F_REC_DATE.value
	objRecordSet.Update

	Msgbox("ê≥èÌÇ…ìoò^Ç≥ÇÍÇ‹ÇµÇΩÅB")
'//	ID_FRM_CONTENT.document.body.innerHTML = "ê≥èÌÇ…ìoò^Ç≥ÇÍÇ‹ÇµÇΩÅB"
'//	RESULT.innerHTML = "ÉfÅ[É^Ç™ìoò^Ç≥ÇÍÇ‹ÇµÇΩÅB"
